...
export function BuccaneerMain(props) {
            ...
            <table className="upgrade_table">
                <thead>
                    <tr>
                        ...
                        <th id="top4" className="top_row last_upgrade_button_off" onClick={() => myFunctions.toggleUpgrade('top', 4)}>Carrier Flagship</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <table className="upgrade_table">
                <thead>
                    <tr>
                        ...
                        <th id="middle4" className="top_row last_upgrade_button_off" onClick={() => myFunctions.toggleUpgrade('middle', 4)}>Pirate Lord</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
