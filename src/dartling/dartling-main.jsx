...
export function DartlingMain(props) {
            ...
            <table className="upgrade_table">
                <thead>
                    <tr>
                        ...
                        <th id="top4" className="top_row last_upgrade_button_off" onClick={() => myFunctions.toggleUpgrade('top', 4)}>Ray of Doom</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <table className="upgrade_table">
                <thead>
                    <tr>
                        ...
                        <th id="middle4" className="top_row last_upgrade_button_off" onClick={() => myFunctions.toggleUpgrade('middle', 4)}>M.A.D.</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
