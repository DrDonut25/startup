                    ...
                    <tr>
                        ...
                        <td class="change_cell">
                            <ul class="change_list">
                                ...
                                <li>+5 range</li>
                                <li><span class="ability">Ability: Deal 750 damage to 1 MOAB on screen (if MOAB destroyed, deal
                                     remaining damage to child Bloons. Follows tower's First/Strong/Last/Close targeting)</span></li>
                                <li><span class="ability">Ability deals 3 splash damage to &lt;= 100 nearby Bloons</span></li>
                        ...
                        <td class="change_cell">
                            <ul class="change_list">
                                ...
                                <li><span class="ability">Ability target damage 750 -&gt; 4500</span></li>
                                <li><span class="ability">Ability cooldown 30s -&gt; 10s</span></li>
                            </ul>
                        </td>
                    </tr>
                </tbody>
                    ...
                    <tr>
                        ...
                        <td class="change_cell">
                            <ul class="change_list">
                                ...
                                <li><span class="ability"><i>Bomb Storm passive ability: when Bloon leaks deal 2,000 damage to it and
                                     all Bloons on screen, then destroy all non-MOABs and blue MOABs on screen (including Camo)</i></span></li>
                                <li><span class="ability"><i>Bomb Storm ability cooldown: 60s</i></span></li>
                            </ul>
                        </td>
                    </tr>
                </tbody>
